...
/**
 * Created by iStar on 2016/12/28.
 */
...
//                ", cnt=" + cnt +
//                ", trigger=" + trigger +
//                ", ioKeyBytes=" + ioKeyBytes +
//                ", iokeys=" + Arrays.toString(iokeys) +
//                ", tp_events=" + Arrays.toString(tp_events) +
...
//    }
    ...
    public String toString() {
        String s = String.format("buttons=0x%x \r\n" +
                        "rotation:\r\nyaw:%05.2f,\r\npitch:%05.2f,\r\nroll:%05.2f" + " x:"+touchpad_x +" y:"+touchpad_y,
                this.ioKeyBytes,
                this.yaw,
                this.pitch,
                this.roll
...
//        BitSet bitSet = BitSet.valueOf(dataIn);
//        BitSet b1 = bitSet.get(0);
//        b1.toByteArray();
